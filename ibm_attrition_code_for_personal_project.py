# -*- coding: utf-8 -*-
"""ibm attrition code for personal project

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1Kphyxp28dHym18hiHgoDH75CtB-0FiJJ
"""
...
# Smaller heatmap: Top correlated features with 'Attrition'
...
# Get top correlations with Attrition (absolute value sorted)
top_corr = corr_matrix['Attrition'].abs().sort_values(ascending=False)

# Exclude 'Attrition' itself
top_features = top_corr[1:11].index  # Top 10 features excluding Attrition

# Subset correlation matrix for those features + Attrition
subset_corr = df_encoded[top_features.tolist() + ['Attrition']].corr()
